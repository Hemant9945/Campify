...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Camify | About</title>
    <!-- Icon -->
    <link rel="icon" href="Assets/image/camify.ico"/>
    <!--CSS only -->
        ...
        <div class="container text-center">
            ...
            <div class="owner">
                <div class="avatar" style="padding-top: 100px">
                    <img src="Assets/image/camifylogo.png" alt="Circle Image" width="100" class="img-no-padding img-responsive">
                </div>
                <div class="name">
                    <h4 style="color: #865BCE;" class="title">CAMIFY
                    <br />
                    </h4>
                    <h6 class="description">Camera Selling Platform</h6>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 ml-auto mr-auto text-center">
                    <p style="color: #fff;">At camify, our mission is to be a company that inspires and fulfills your curiosity. Using our unlimited passion for technology.</p>
                </div>
            </div>
            <br />
        </div>
                    ...
                    <div class="card card-profile card-plain">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-description text-center">
                                You will get one of the best products here.
                            </p>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="card card-profile card-plain">
                        ...
                        <div class="card-body">
                            <a href="#paper-kit">
                                <div class="author">
                                    <h4 class="card-title">Hemant Rajeshirke</h4>
                                    <h6 class="card-category" style="color: #865BCE;">Founder</h6>
                                </div>
                            </a>
                            <p class="card-description text-center">
                               Our website will provide you with the best and latest technologies of cameras.
                            </p>
                        </div>
                        <div class="card-footer text-center">
                            <a href="#pablo" class="btn btn-link btn-just-icon btn-neutral"><i class="fab fa-twitter"></i></a>
                ...
                <div class="col-md-4">
                    <div class="card card-profile card-plain">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-description text-center">
                                Our brand of campify is a new startup which will help many beginner photographers to choose their first camera.
                            </p>
                        </div>
                        <div class="card-footer text-center">
                            <a href="#pablo" class="btn btn-link btn-just-icon btn-neutral"><i class="fab fa-twitter"></i></a>
