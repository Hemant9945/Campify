...
<head runat="server">
    ...
    <style>
        ...
        .page-header{
            ...
            background-image: url('https://localhost:44331/Assets/image/signup2.jpg')
        }
        .fab:hover{
...
<body>
        ...
        <div class="container-fluid">
            <div class="mr-auto d-block">
                <a class="navbar-brand" href="Home.aspx" rel="tooltip" data-placement="bottom">
                    <img src="Assets/image/camifylogo.png" style="height: 40px" />
                </a>
            </div>
    ...
    <div class="footer register-footer text-center">
        ...
        </script>, Camify <i class="fa fa-heart heart"></i></h6>
    </div>
</body>
</html>